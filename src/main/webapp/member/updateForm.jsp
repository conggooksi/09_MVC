...
<body>
  ...
  <form method="post" action="${ctxpath}/member/updatePro.do" onSubmit="return check()">
    <table border="1">
      <tr>
        <td>ID</td>
        <td><input type="text" name="id" id="id" value="${sessionScope.id}"size="20" readonly></td>
      </tr>
      ...
      <tr>
        <td>Email</td>
        <td><input type="text" name="email" id="email" value="${dto.email}" size="30"></td>
      </tr>
      
      <tr>
        <td>전화</td>
        <td><input type="text" name="tel" id="tel" value="${dto.tel}" size="30"></td>
      </tr>
      ...
      <tr>
        ...
        <td>
          ...
          <br>
                       상세주소:<input type="text" name="addr2" id="addr2" value="${dto.addr2}" placeholder="상세주소">
        </td>
      </tr>
